...
public class DisplayPropertyTypes {
    ...
    public static final PropertyType<Optional<Brightness>> BRIGHTNESS = get("display/brightness", new TypeToken<>() {
    });
    ...
    public static final PropertyType<Optional<Color>> GLOW_COLOR = get("display/glowing/color", new TypeToken<>() {
    });
