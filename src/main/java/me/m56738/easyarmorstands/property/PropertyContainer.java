...
public interface PropertyContainer {
     ...
     *
     * @param editableObject The object whose properties should be used.
     ...
     */
    static PropertyContainer tracked(EditableObject editableObject, Player player) {
        return new TrackedPropertyContainer(editableObject, player);
    }
     ...
     * @see #tracked(EditableObject, Player) Tracking changes and adding them to the history
     */
