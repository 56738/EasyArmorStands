...
public class MannequinHatVisibleProperty extends AbstractMannequinSkinPartVisibleProperty {
    public MannequinHatVisibleProperty(Mannequin mannequin) {
        super(mannequin, MannequinPropertyTypes.SKIN_PART_VISIBLE.get(SkinPart.HAT));
    }

    @Override
    protected boolean getValue(SkinParts parts) {
        return parts.hasHatsEnabled();
    }

    @Override
    protected void setValue(SkinParts.Mutable parts, boolean value) {
        parts.setHatsEnabled(value);
    }
}
