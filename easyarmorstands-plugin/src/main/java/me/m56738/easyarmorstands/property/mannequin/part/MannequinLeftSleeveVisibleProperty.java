package me.m56738.easyarmorstands.property.mannequin.part;
...
public class MannequinLeftSleeveVisibleProperty extends AbstractMannequinSkinPartVisibleProperty {
    public MannequinLeftSleeveVisibleProperty(Mannequin mannequin) {
        super(mannequin, MannequinPropertyTypes.SKIN_PART_VISIBLE.get(SkinPart.LEFT_SLEEVE));
    }

    @Override
    protected boolean getValue(SkinParts parts) {
        return parts.hasLeftSleeveEnabled();
    }

    @Override
    protected void setValue(SkinParts.Mutable parts, boolean value) {
        parts.setLeftSleeveEnabled(value);
    }
}
