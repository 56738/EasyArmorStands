...
public class ArmorStandPoseLocalRotateAxis implements RotateAxis {
    ...
    public ArmorStandPoseLocalRotateAxis(PropertyContainer properties, ArmorStandPart part, Axis axis) {
    ...
    public @NotNull Quaterniondc getRotation() {
        float yaw = locationProperty.getValue().getYaw();
        return Util.fromEuler(poseProperty.getValue(), currentRotation)
                .rotateLocalY(-Math.toRadians(yaw));
    }
    ...
    public double start() {
        ...
        axis.getDirection().rotate(originalRotation, axisDirection);
        return 0;
    }
