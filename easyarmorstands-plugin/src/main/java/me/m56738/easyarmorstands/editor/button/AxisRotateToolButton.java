...
public class AxisRotateToolButton implements NodeFactoryButton {
    ...
    public AxisRotateToolButton(Session session, AxisRotateTool tool, double radius, double length, Component name, ParticleColor color) {
