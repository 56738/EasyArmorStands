...
public class MoveToolButton extends SimpleButton implements NodeFactoryButton {
    private final Session session;
    private final MoveTool tool;
    private final Component name;

    public MoveToolButton(Session session, MoveTool tool, Component name, ParticleColor color) {
        super(session, color);
