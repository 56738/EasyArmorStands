...
public class BoxResizeToolManager {
    ...
    public BoxResizeToolManager(Session session, MenuLayer menuLayer, BoundingBoxEditor editor) {
    ...
    private void addAxisEnd(Axis axis, boolean end) {
        ...
        menuLayer.addButton(new BoxResizeButton(session, name.color(NamedTextColor.AQUA), ParticleColor.AQUA, tool));
    }
}
