...
public class ScaleToolLayer extends ToolLayer implements ValueLayer<Double> {
    ...
    public ScaleToolLayer(Session session, ScaleToolSession toolSession, Component name, ParticleColor color, Vector3dc position) {
