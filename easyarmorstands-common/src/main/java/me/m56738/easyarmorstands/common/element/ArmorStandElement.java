...
import me.m56738.easyarmorstands.common.editor.armorstand.ArmorStandRotationProvider;
import me.m56738.easyarmorstands.common.editor.armorstand.node.ArmorStandRootNode;
...
public class ArmorStandElement extends SimpleEntityElement {
    ...
    public ArmorStandElement(EasyArmorStandsCommon eas, Entity entity, SimpleEntityElementType type) {
    ...
    public @NotNull ToolProvider getTools(@NotNull ChangeContext context) {
        return new ArmorStandToolProvider(eas, this, context);
    }
