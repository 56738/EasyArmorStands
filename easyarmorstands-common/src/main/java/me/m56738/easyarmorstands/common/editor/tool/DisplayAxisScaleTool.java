...
public class DisplayAxisScaleTool implements AxisScaleTool {
    ...
    public DisplayAxisScaleTool(EasyArmorStandsCommon eas, ToolContext context, ChangeContext changeContext, PropertyContainer properties, Axis axis) {
        this.eas = eas;
    ...
    private class SessionImpl implements AxisScaleToolSession {
        ...
        public void setChange(double change) {
            ...
            axis.setValue(scaleVector, (float) clampScale(axis.getValue(scaleVector) * change));
        ...
        public void setValue(double value) {
            Vector3f scaleVector = new Vector3f(originalScale);
            axis.setValue(scaleVector, (float) clampScale(value));
            scaleProperty.setValue(scaleVector);
        }
