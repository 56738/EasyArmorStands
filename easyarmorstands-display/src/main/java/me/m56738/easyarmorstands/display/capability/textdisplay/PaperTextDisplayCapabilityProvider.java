package me.m56738.easyarmorstands.display.capability.textdisplay;
...
public class PaperTextDisplayCapabilityProvider implements CapabilityProvider<TextDisplayCapability> {
    @Override
