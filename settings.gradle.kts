...
includeAt("easyarmorstands-platform-neoforge", "platform/neoforge")
...
includeAt("easyarmorstands-neoforge", "neoforge")
includeAt("easyarmorstands-neoforge-api", "neoforge/api")
