package gg.bundlegroup.easyarmorstands.platform.bukkit.v1_14;

import gg.bundlegroup.easyarmorstands.platform.bukkit.BukkitMain;
...
public class ToolCheckerImpl implements ToolChecker {
    private final NamespacedKey key = new NamespacedKey(BukkitMain.getInstance(), "tool");
