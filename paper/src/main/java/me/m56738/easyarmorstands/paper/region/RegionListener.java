package me.m56738.easyarmorstands.paper.region;
...
public class RegionListener implements Listener {
    ...
    private boolean isAllowed(Player player, Location location, boolean silent) {
        return privilegeChecker.isAllowed(player, PaperAdapter.toNative(location), silent);
    }
    ...
    public void onEdit(PlayerEditPropertyEvent<?> event) {
        ...
        if (isAllowed(event.getPlayer(), entity.location(), true)) {
